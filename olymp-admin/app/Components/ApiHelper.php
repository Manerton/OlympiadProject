...
class ApiHelper
{
    ...
    public const NGINX_SERVER_HOST = 'http://nginx_server';
    ...
    public const SEND_CODE_URL_API = self::NGINX_SERVER_HOST . '/index.php?r=email%2Fsend-code';
    public const SEND_MESSAGE_URL_API = self::NGINX_SERVER_HOST . '/index.php?r=email%2Fsend-message';
