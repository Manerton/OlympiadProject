        ...
        return response()->json([
            ...
            'eventJuries' => array_map(function ($jury) {
                return [
                    'id' => $jury->id,
                    'userAPI' => [
                        'firstname' => $jury->userAPI->firstname ?? null,
                        'surname' => $jury->userAPI->surname ?? null,
                        'patronymic' => $jury->userAPI->patronymic ?? null,
                    ],
                ];
            }, $eventJuries),
            'subjects' => $subjects,
    ...
    public function prizeScore($id)
    {
        ...
        return response()->json([
            'eventScore' => [
                'id' => $eventScore->id,
                'event_id' => $event->id,
                'eventAPI' => $eventScore->eventAPI,
                'winner_score' => $eventScore->winner_score,
                'prize_score' => $eventScore->prize_score,
            ],
            'event' => (array)$event,
        ]);
    }
