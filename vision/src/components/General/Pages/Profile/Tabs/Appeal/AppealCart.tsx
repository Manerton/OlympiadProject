    ...
    return (
        <div className="card mb-3">
            <div className="card-body">
                ...
                <p className="card-text"><strong>Тип задачи:</strong> {taskTypeLabels[appeal.TaskType]}</p>
                <p className="card-text"><strong>Причина:</strong> {appeal.Reason}</p>
                <p className="card-text"><strong>Статус:</strong><StatusIcon status={appeal.Status} /></p>
            </div>
        </div>
    );
}
