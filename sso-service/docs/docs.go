...
const docTemplate = `{
        ...
        "/api/participants": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Ограничение на количество записей",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user_dto.SearchAttributesUserDTO"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "participant_dto.UpdateParticipantRequestDTO": {
            "type": "object",
            "properties": {
                "citizenship": {
                    "type": "string"
        ...
        "user_dto.SearchAttributesUserDTO": {
            "type": "object",
            "properties": {
                "activated": {
                    "type": "boolean"
        ...
        "user_dto.UserParticipantResponseDTO": {
            "type": "object",
            "properties": {
                "activated": {
                    "type": "boolean"
