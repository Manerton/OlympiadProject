...
func TestCreateApplication(t *testing.T) {
	...
	application := models.Application{UserID: 1, EventID: 1}
...
func TestGetApplicationByID(t *testing.T) {
	...
	application := models.Application{ApplicationID: 1, UserID: 1, EventID: 1, Status: nil}
...
func TestGetAllApplications(t *testing.T) {
	...
	db.Create(&models.Application{UserID: 1, EventID: 1})
	db.Create(&models.Application{UserID: 2, EventID: 2})
...
func TestUpdateApplicationStatus(t *testing.T) {
	...
	application := models.Application{UserID: 1, EventID: 1, Status: nil}
	db.Create(&application)
